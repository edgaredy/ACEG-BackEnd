 ...
 */
package com.aceg.springboot.backend.rowmapper.proveedor;
...
import com.aceg.springboot.backend.models.proveedor.ProvProductoProvBean;
...
public class ProvProdProvRowMapper implements RowMapper<ProvProductoProvBean> {
	 ...
	 *                         	  SQLException)
	 * @return provProdProv    -  El valor resultante (puede ser null)
	 */
	@Override
